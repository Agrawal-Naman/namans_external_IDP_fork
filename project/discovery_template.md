...
:::{note}
Replace all content below with your own content.
:::

:::{attention}
You must submit your finished document **as a Markdown (.md) file** to the `discovery/` folder in your final project GitHub repository. If it is not present, add it. **It should not be submitted to Schoology.**
:::
...
:::{note}
Replace the title above. It should reflect your specific research questions (not just “Intermediate Data Programming Project”). It must be short/succinct and `catchy` and reflect the scope of your intended research work.  
:::
